...
export const updatePostFail = createAction('[Post/API] Update post fail', props<{ error: any }>());
...
export const createPostFail = createAction('[Post/API] Create post fail', props<{ error: any }>());
...
export const deletePostsFail = createAction('[Post/API] Delete posts fail', props<{ error: any }>());
